<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WelCome.aspx.cs" Inherits="HelloLLLLL.Blog.Admin.page.WelCome" %>
        ...
        <div class="layui-row layui-col-space15">
            <div class="layui-col-md8">
                <div class="layui-row layui-col-space15">
                    ...
                    <div class="layui-col-md12">
                        <div class="layui-card">
                            <div class="layui-card-header"><i class="fa fa-line-chart icon"></i>登录日志</div>
                            <div class="layui-card-body">
                                <table id="demo"></table>
                            </div>
                        </div>
            ...
            <div class="layui-col-md4">
                ...
                <div class="layui-card">
                    ...
                    <div class="layui-card-body layui-text" id="llNotice">
                ...
                <div class="layui-card">
                    ...
                    <div class="layui-card-body layui-text layadmin-text">
                        ...
                        <p>技术交流QQ群（667813249）：<a target="_blank" href="https://jq.qq.com/?_wv=1027&k=5lyiE2Q"><img border="0" src="//pub.idqqimg.com/wpa/images/group.png" alt="layuimini" title="layuimini"></a>（加群请备注来源：如gitee、github、官网等）</p>
...
<script>
        ...
        $.ajax(
            {
                ...
                success: function (data1) {
                    ...
                    for (var i = 0; i < data1.data.length; i++) {
                        var no = data1.data[i];
                        notice += '<div class="layuimini-notice">'
                            +'<div class="layuimini-notice-title" >'+no.Title+'</div >'
                                +'<div class="layuimini-notice-extra">'+no.NoticeTime+'</div>'
                            + ' <div class="layuimini-notice-content layui-hide">'
                           + no.NoticeContent     
                            + '</div></div>'
    ...
    layui.use(['table','layer', 'miniTab'], function () {
        var $ = layui.jquery,
            layer = layui.layer,
        ...
        table.render({
            elem: '#demo'
            , height: 312
            , url: '/admin/AdminPostData.ashx?action=loginInfo' //数据接口
            , page: true //开启分页
            ,limit:2
            , cols: [[ //表头
                ...
                , { field: 'LoginDate', title: '登录时间', width: 170, sort: true }
                , { field: 'UserOS', title: '操作系统', width: 170 }                
            ]]
        });
