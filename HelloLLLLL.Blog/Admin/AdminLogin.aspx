<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminLogin.aspx.cs" Inherits="HelloLLLLL.Blog.Admin.AdminLogin" %>
    ...
    <div class="admin-login-background">
        ...
        <form class="layui-form"  method="post">
            ...
            <div>
                ...
                <img class="admin-captcha" id="llYzm" width="90" height="30" src="AdminPostData.ashx?action=yzm" onclick="getNewyzm()"/>
            </div>
...
<script>
    function getNewyzm() {
        ...
        var src = $("#llYzm").attr("src");

        var index = src.indexOf("yzm");

        src = src.substring(0, index + 3);
        
        src+="&date="+new Date().getMilliseconds();
    ...
    layui.use(['form'], function () {
        ...
        form.on('submit(login)', function (data) {
            ...
            $.ajax(
                {
                    url: "AdminPostData.ashx?action=adminLogin",
                    type: "post",
                    data: data,
                    dataType: "JSON",
                    success: function (dd) {
